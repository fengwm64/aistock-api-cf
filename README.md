...
```json
{
  ...
  "data": {
    ...
    "摘要": "今日A股三大指数集体收涨，沪指涨0.75%，深成指涨1.23%，创业板指涨1.56%。",
    "正文": "今日A股三大指数集体收涨，沪指涨0.75%，收报3234.56点；深成指涨1.23%，收报10567.89点；创业板指涨1.56%，收报2345.67点。\n\n盘面上，新能源、半导体、人工智能等板块涨幅居前，煤炭、钢铁等传统行业表现低迷。\n\n成交量方面，沪深两市成交额达到8500亿元，较前一交易日有所放大。"
  }
}
```
